# Generated by Django 5.0.1 on 2024-03-09 14:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('scooty', 'scooty'), ('CAT', 'Cat'), ('bike', 'bike')], max_length=20)),
                ...
                ('Automobile_image', models.ImageField(upload_to='Automobile_images')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.automobile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Automobile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.automobile')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
